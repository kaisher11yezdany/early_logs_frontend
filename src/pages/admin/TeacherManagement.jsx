  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (editData && editData._id && !editData.noProfile) {
        ...
        // Brand new teacher — password defaults to employeeId if blank
        await api.post('/teachers', { ...payload, password: form.password || form.employeeId });
      }
                ...
                <div>
                  ...
                  <div className="relative">
                    <input className="input-field pr-10"
                      ...
                      placeholder={editData ? 'Leave blank to keep current' : 'Leave blank to use Employee ID'}
